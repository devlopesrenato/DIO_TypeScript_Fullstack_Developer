          ...
          isLoggedIn && (
            <>
              ...
              <Text
                ...
                mr='3'
              >
                {user ? <FaUserAlt style={{ marginRight: '5' }} /> : <></>}
                {user?.name}
              </Text>
              <Button
                onClick={() => logout()}
